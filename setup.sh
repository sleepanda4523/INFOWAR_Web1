...
MYSQL_ROOT_PWD=${MYSQL_ROOT_PWD:-"imadmin1234"}
MYSQL_USER=${MYSQL_USER:-"ctfadmin"}
MYSQL_USER_PWD=${MYSQL_USER_PWD:-"ctfadmin1234"}
MYSQL_USER_DB=${MYSQL_USER_DB:-"ctfweb"}
...
mysql --user=root --password=root -e "ALTER USER 'root'@'localhost' IDENTIFIED BY '$MYSQL_ROOT_PWD'; FLUSH PRIVILEGES;"
